...
((exports)=>{
	...
	class EventEmitter {
		...
		**/
		...
		/**
		 * Retrieve the version of EventEmitter
		 *
		 * @property-read {string[]} events
		**/
		static get version() { return VERSION; }
		static set version(val) { throw new TypeError("Cannot assign to read only property 'version' of <EventEmitter>"); }
		// endregion
		
		/**
		 * Revert to previous version of EventEmitter
		 *
		 * @returns {EventEmitter}
		 */
		static noConflict() {
